...
int main() {
    ...
    Rule *rule8 = (Rule *)Dynarr_get(&rules, 8);
    SubRule sr42_8;
    sr42_8.references = Dynarr_create(int);
    int i = 42;
    Dynarr_insert(&sr42_8.references, &i);
    i = 8;
    Dynarr_insert(&sr42_8.references, &i);
    Dynarr_insert(&rule8->value.subrules, &sr42_8);
    Rule *rule11 = (Rule *)Dynarr_get(&rules, 11);
    SubRule sr42_11_31;
    sr42_11_31.references = Dynarr_create(int);
    i = 42;
    Dynarr_insert(&sr42_11_31.references, &i);
    i = 11;
    Dynarr_insert(&sr42_11_31.references, &i);
    i = 31;
    Dynarr_insert(&sr42_11_31.references, &i);
    Dynarr_insert(&rule11->value.subrules, &sr42_11_31);
